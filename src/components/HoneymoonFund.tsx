  ...
  return (
    <section id="honeymoon" className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="section-heading !text-white">Honeymoon Fund</h2>
        <p className="section-subheading !text-white/80">If you&apos;d like to contribute</p>

        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8 md:p-12 border border-white/50">
          <p className="text-stone-600 leading-relaxed text-lg mb-10 max-w-md mx-auto">
            Your presence is the greatest gift. If you would like to contribute to our honeymoon,
            you can do so below.
          </p>

          <a
            href="https://monzo.me/YOUR_MONZO_HANDLE"
            target="_blank"
