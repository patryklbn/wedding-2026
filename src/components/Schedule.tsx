  ...
  const weddingDayEvents = [
    {
      time: '13:00',
      title: 'Guest Arrival',
      description: 'Guests arrive at Broxmouth Courtyard. Smart attire or kilts welcome.',
      icon: (
    ...
    },
    {
      time: '14:00',
      title: 'Ceremony',
      description: 'Exchange of vows in the Broxmouth Courtyard.',
      icon: (
    ...
    },
    {
      ...
      description: 'Cocktails, photos and music as we celebrate after the ceremony.',
      icon: (
    ...
    },
    {
      ...
      description: 'Dinner, speeches and toasts in the main hall.',
      icon: (
    ...
    },
    {
      time: '20:00',
      title: 'First Dance',
      description: 'The newlyweds take to the floor.',
      icon: (
    ...
    },
    {
      ...
      description: 'Ceilidh, DJ, dancing and celebration into the night.',
      icon: (
    ...
    <>
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-md p-5 hover:shadow-lg transition-shadow duration-300">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <span className="md:hidden font-serif text-lg text-sage-600 block mb-1">
                            {event.time}
                          </span>
      ...
      <section id="day-after" className="py-20 md:py-28 bg-sage-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="section-heading">The Day After</h2>
          <p className="section-subheading">Sunday Gathering</p>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-8 md:p-10 text-center">
            ...
            <p className="font-serif text-lg md:text-xl text-stone-600 leading-relaxed mb-8">
              Scottish/Polish-style poprawiny: a relaxed day-after pub gathering for close friends.
            </p>

            <div className="border-t border-stone-200 pt-8">
              <div className="grid md:grid-cols-2 gap-8 text-left max-w-lg mx-auto">
                <div>
                  <h4 className="text-xs uppercase tracking-widest text-sage-600 font-medium mb-2">
                    Location
                  </h4>
                  <p className="font-serif text-lg text-stone-700 mb-1">One Canon, Public Hoose</p>
                  <p className="text-stone-500 text-sm leading-relaxed">
                    1 Canonmills, Edinburgh<br />
                    EH3 5HA, United Kingdom
                  </p>
                </div>
                <div>
                  <h4 className="text-xs uppercase tracking-widest text-sage-600 font-medium mb-2">
            ...
            <div className="mt-8">
              <a
                href="https://maps.google.com/?q=One+Canon+1+Canonmills+Edinburgh+EH3+5HA"
                target="_blank"
